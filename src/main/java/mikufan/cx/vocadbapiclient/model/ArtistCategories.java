// auto fixed by vocadb-apiclient-fixer at 2023-12-26T08:02:04.633823888
/*
 * VocaDbWeb
...
public class ArtistCategories {
  ...
  @JsonCreator
  public static ArtistCategories fromValue(String value) {
    if (value == null || value.isEmpty()){
      return null;
    }
    return new ArtistCategories(value);
  }

  public ArtistCategories(String... constantNames) {
    enums = new HashSet<>();
  ...
  public ArtistCategories(Constant... constants){
    enums = new HashSet<>();
  ...
  public boolean equals(Object o) {
    ...
    ArtistCategories that = (ArtistCategories) o;

// auto fixed by vocadb-apiclient-fixer at 2023-12-26T08:02:04.633923743
/*
 * VocaDbWeb
...
/**
 * Gets or Sets CommentOptionalFields
 */
public class CommentOptionalFields {
  ...
  @JsonCreator
  public static CommentOptionalFields fromValue(String value) {
    if (value == null || value.isEmpty()){
      return null;
    }
    return new CommentOptionalFields(value);
  }

  public CommentOptionalFields(String... constantNames) {
    enums = new HashSet<>();
  ...
  public CommentOptionalFields(Constant... constants){
    enums = new HashSet<>();
  ...
  public boolean equals(Object o) {
    ...
    CommentOptionalFields that = (CommentOptionalFields) o;

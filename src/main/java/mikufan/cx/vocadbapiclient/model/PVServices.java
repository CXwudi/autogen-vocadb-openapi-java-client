// auto fixed by vocadb-apiclient-fixer at 2023-12-26T08:02:04.634101829
/*
 * VocaDbWeb
...
public class PVServices {
  ...
  public static PVServices fromValue(String value) {
    ...
    return new PVServices(value);
  }

  public PVServices(String... constantNames) {
    enums = new HashSet<>();
  ...
  public PVServices(Constant... constants){
    enums = new HashSet<>();

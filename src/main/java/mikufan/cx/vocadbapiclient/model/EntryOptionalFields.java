// auto fixed by vocadb-apiclient-fixer at 2023-12-26T08:02:04.633959836
/*
 * VocaDbWeb
...
/**
 * Gets or Sets EntryOptionalFields
 */
public class EntryOptionalFields {
  ...
  @JsonCreator
  public static EntryOptionalFields fromValue(String value) {
    if (value == null || value.isEmpty()){
      return null;
    }
    return new EntryOptionalFields(value);
  }

  public EntryOptionalFields(String... constantNames) {
    enums = new HashSet<>();
  ...
  public EntryOptionalFields(Constant... constants){
    enums = new HashSet<>();
  ...
  public boolean equals(Object o) {
    ...
    EntryOptionalFields that = (EntryOptionalFields) o;

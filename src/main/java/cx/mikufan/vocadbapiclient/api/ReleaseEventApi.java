...
import cx.mikufan.vocadbapiclient.model.EventReportType;
import cx.mikufan.vocadbapiclient.model.EventSortRule;
...
import cx.mikufan.vocadbapiclient.model.ReleaseEventForApiContractPartialFindResult;
import cx.mikufan.vocadbapiclient.model.ReleaseEventOptionalFields;
...
@Component("cx.mikufan.vocadbapiclient.api.ReleaseEventApi")
public class ReleaseEventApi {
    private ApiClient apiClient;

    public ReleaseEventApi() {
        this(new ApiClient());
    }

    @Autowired
    public ReleaseEventApi(ApiClient apiClient) {

...
@Component("cx.mikufan.vocadbapiclient.api.UserApi")
public class UserApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public String apiUsersCurrentAlbumsAlbumIdPost(Integer albumId, PurchaseStatus collectionStatus, cx.mikufan.vocadbapiclient.model.MediaType mediaType, Integer rating) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<String> apiUsersCurrentAlbumsAlbumIdPostWithHttpInfo(Integer albumId, PurchaseStatus collectionStatus, cx.mikufan.vocadbapiclient.model.MediaType mediaType, Integer rating) throws RestClientException {
        Object postBody = null;
     ...
     * <p><b>200</b> - Success
     * @param id  (required)
     * @param messageId  (optional, default to new ArrayList&lt;&gt;())
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */

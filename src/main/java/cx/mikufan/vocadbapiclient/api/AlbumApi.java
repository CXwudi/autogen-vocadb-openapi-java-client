...
import cx.mikufan.vocadbapiclient.model.AlbumForApiContractPartialFindResult;
...
import cx.mikufan.vocadbapiclient.model.AlbumReviewContract;
...
import cx.mikufan.vocadbapiclient.model.SongInAlbumForApiContract;
...
@Component("cx.mikufan.vocadbapiclient.api.AlbumApi")
public class AlbumApi {
     ...
     * <p><b>200</b> - Success
     * @param id  (required)
     * @param field  (optional, default to new ArrayList&lt;&gt;())
     ...
     * 
     * <p><b>200</b> - Success
     * @param ignoreIds  (optional, default to new ArrayList&lt;&gt;())
     * @param languagePreference  (optional)
     * @param fields  (optional)
     * @return List&lt;AlbumForApiContract&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
